...
public class CardGameServer {
	...
	private BufferedReader clientReader = null; // TO BE DELETED
	...
	private class ClientHandler implements Runnable {
		...
		TO BE DELETED
		 */
		private BufferedReader reader = clientReader;
...
//
//
//					// Once a non-null message is received, stop waiting for the next message.
//					break;
//				}
...
//				// possible connection loss, removes the connection
//				removeConnection(clientSocket);
//				// NOTE: message is not handled here
//				msg = null;
//			}
